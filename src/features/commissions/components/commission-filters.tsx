 ...
 *
 * Client component for filtering commissions by status and date range.
 */
...
export function CommissionFilters({ filters, onChange }: Props) {
        ...
        <div className="space-y-2">
          ...
          >
            ...
            <SelectContent>
              ...
              {Object.entries(COMMISSION_STATUS_LABELS).map(([status, label]) => (
