/**
 * Affiliate Bookings Table Component
 *
 * Displays bookings generated by the user's referral links.
...
import { useAffiliateBookings, useAffiliateBookingStats } from '../hooks';
...
export function AffiliateBookingsTable() {
  const [filters, setFilters] = useState<Filters>({});

  const { data: bookings, isLoading, error } = useAffiliateBookings(filters);
  const { data: stats } = useAffiliateBookingStats();
